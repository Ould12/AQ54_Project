...
const Login = () => {
    ...
    // Gérer la soumission du formulaire de connexion par email et mot de passe
    const handleEmailSignIn = async (e) => {
        ...
        if (!isSigningIn) {
            ...
            try {
                ...
                setIsSigningIn(false); // Permet de réessayer la connexion
            }
        }
    };

    // Gérer la connexion via Google
            ...
            <main className="w-full h-screen flex justify-center items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    <div className="text-center">
                        <h3 className="text-gray-800 text-xl font-semibold sm:text-2xl">AQ54 Login</h3>
                    </div>
